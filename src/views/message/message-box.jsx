...
import MessageBoxList02 from './message-box-list02';
...
function MessageBox() {
    ...
    const getListMob = () => {
        ...
        axios.post("/api/app/msg/savebox", listParm
            , {
    ...
    // 메세지 보관함 검색하기
    const searchList = () => {
        ServiceFetch("/msg/savebox/search", "post", {
    ...
    const getMsgSearchMob = () => {
        ...
        axios.post("/api/app/msg/savebox/search", listParm, {
            withCredentials: true,
            headers: {
                accessToken: getCookie("accessToken"),
                lastLoginTime: getCookie("lastLoginTime"),
        ...
        if (msgSendTitle.length >= 201) {
            ...
            ServiceFetch("/msg/reply", "post", {
                ...
                res.resultCode === '200' ? (
                    ...
                    setEditorData(""),
                    setMsgSendTitle(""),
                    !isMobile ? (msgState ? searchList() : getList()) : (msgState ? getMsgSearchMob() : getListMob())
                ) : res.resultCode === '301' ? (
                    setModalFail(true)
                ) : res.resultCode === '302' ? (
                    setMsgSendFail(true)
    ...
    return (
        <>
            <div className="message-sent">
                        ...
                        <div className="col-span-12 relative">
                            <div className="flex flex-col items-end lg:flex-row itmes-center space-between">
                                <div className="flex items-center gap-2 w-full lg:w-auto">
                                    ...
                                    >
                                        <option value="20601">受信者/発信者</option>
                                            ...
                                            messageList?.length > 0 ? messageList.map((message) => {
                                                return (
                                                    <MessageBoxList02
                                                        ...
                                                        msgSendDate={message.msgSendDate}
                                                ...
                                                <tr>
                                                    <td colSpan={6}>メッセージ保管箱が空いています。</td>
                                                </tr>
                                            )
                                        }
                                    </tbody>
                ...
                {!isMobile && messageList?.length > 0 ? <Pagination
                    pgnInfo={pgnInfo}
            ...
            >
                <a onClick={() => { setReceptionState({}); setMsgModal(false); }} className="absolute right-0 top-0 mt-3 mr-3" href="#">
