...
import ResumeMobile8 from "../../components/resume-mobile/resume-mobile-8";
import ResumeMobile9 from "../../components/resume-mobile/resume-mobile-9";
        ...
        <>
            <div className="resume-mng">
                <div className="mo-resume-mng">
                    <ResumeMobile9  progress="progress-bar  w-1/5 bg-green"/>
                </div>
            </div>
            <MobileBottom2 />
        </>
...
export default ResumeRegistMo9;
