...
import ResumeMobile6 from "../../components/resume-mobile/resume-mobile-6";
        ...
        <>
            <div className="resume-mng">
                <div className="mo-resume-mng">
                    <ResumeMobile6  progress="progress-bar  w-1/5 bg-green"/>
                </div>
            </div>
            <MobileBottom2 />
        </>
...
export default ResumeRegistMo6;
