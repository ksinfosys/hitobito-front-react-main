...
const ResumeRegist = () => {
  ...
  const handleCareerChange = async (e, idx) => {
    ...
    tempArr[idx] =
      id === "projectPeriod" ? parseInt(e.target.value) : e.target.value;
      ...
      temp: {
        ...
        [key]: item
          ...
          : {
              ...
              [key === "skillCategory" ? key + "Code" : "careerCode"]:
                e.target.value,
            },
      },
    });
    ...
    if (skillItem.temp.skillCode && skillItem.temp.careerCode) {
      if (
        skillItem.arr.filter(
          (skill) => skill.name === skillItem.temp.skillCode.skillName
        ).length > 0
      ) {
        alert("スキルが重複されました。");
  ...
  const handleSubmit = async () => {
    ...
    rsFileDocument.length > 0
      ...
      : formData.append("rsFileDocument", new File([], "photo.jpg"));
    rsFilePhoto.length > 0
      ? rsFilePhoto.map((item) => formData.append("rsFilePhoto", item))
      : formData.append("rsFilePhoto", new File([], "document.pdf"));

    //서버로 보내기
    axios
      .post("/api/resume/reg", formData, {
        headers: {
    ...
    axios
      ...
      .then((res) => {
        ...
        setSkillList({
          ...skillList,
          category: Array.from(
            new Set(res.data.result.skillList.map((item) => item.skillCategory))
          ),
        ...
        setMobileStatus({
          ...mobile,
          api: res.data.result,
          businessDepthMenu: DepthSplit(
            mobile,
            "businessDepthMenu",
            "businessTypeList",
            "businessType"
          ),
          jobDepthMenu: DepthSplit(
            mobile,
            "jobDepthMenu",
            "jobTypeList",
            "jobType"
          ),
          hopeCareerDepthMenu: DepthSplit(
            mobile,
            "hopeCareerDepthMenu",
            "hopeCareerList",
            "hopeCareer"
  ...
  return (
    <>
          ...
          <div className="resume-regist-cont">
              ...
              <div className="box-item flex flex-col">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="btn btn-sm btn-ouline-secondary w-40 btn-age">
                    {body && body.userAge ? handleAgeCalculator() : "0歳"}
                  </div>
                </div>
              </div>
              <div className="box-item flex flex-col">
              ...
              <div className="box-item flex flex-col">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="form-check form-switch flex gap-2">
                    <div className="switch-tit shrink-0 w40">
            ...
            <div className="form-flex-box flex space-between items-start">
              <div className="box-item2 flex flex-col">
                ...
                >
                  {depthMenu.hopeCareer.depth_first} &gt;{" "}
      ...
      >
        <ModalBody className="p-10 text-center">
          <div className="modal-tit mb-5">글자는 200까지 입력 가능합니다.</div>
